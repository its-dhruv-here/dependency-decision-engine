...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen pt-20">
      ...
      <aside className="hidden lg:flex flex-col p-8 space-y-10 h-full w-72 border-r border-slate-100 bg-white fixed left-0 top-20 bottom-0">
        <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <section className="lg:col-span-8 space-y-12">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-6 pt-12">
                <button 
                  onClick={handleSave}
                  className="w-full sm:w-auto bg-primary text-on-primary px-10 py-4 rounded-full font-bold text-sm tracking-tight hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 active:scale-[0.97]">
                  Save Preferences
                </button>
                <button 
                  onClick={handleReset}
            ...
            <aside className="lg:col-span-4 space-y-8">
              <div className="bg-white p-8 rounded-2xl shadow-[0_8px_32px_rgba(26,26,46,0.04)] border border-outline-variant/10">
